...
const Dashboard = () => {
  ...
  // Export functions for different chart types
  const exportChartDataToExcel = (data, filename) => {
  ...
  const exportRevenueLineChart = () => {
    exportChartDataToExcel(chartData, 'Revenue_LineChart_Data');
  };

  const exportDistributionPieChart = () => {
    const pieData = [
      { name: 'Orders', value: stats.totalOrders },
      { name: 'Cars', value: stats.totalCars },
      { name: 'Users', value: stats.totalUsers }
    ];
    exportChartDataToExcel(pieData, 'Distribution_PieChart_Data');
  };

  const exportRevenueBarChart = () => {
    exportChartDataToExcel(chartData, 'Revenue_BarChart_Data');
  };
  ...
  // Button style for export buttons
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '40px', marginBottom: '40px' }}>
        ...
        <div style={{ backgroundColor: 'white', padding: '20px', borderRadius: '8px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
            ...
            <button
              onClick={exportRevenueLineChart}
        ...
        <div style={{ backgroundColor: 'white', padding: '20px', borderRadius: '8px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
            ...
            <button
              onClick={exportDistributionPieChart}
              style={exportButtonStyle}
              onMouseOver={(e) => e.target.style.backgroundColor = '#218838'}
              onMouseOut={(e) => e.target.style.backgroundColor = '#28a745'}
            >
        ...
        <div style={{ gridColumn: '1 / -1', backgroundColor: 'white', padding: '20px', borderRadius: '8px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
            <h3 style={{ margin: 0 }}>Revenue Bar Chart</h3>
            <button
              onClick={exportRevenueBarChart}
              style={exportButtonStyle}
              onMouseOver={(e) => e.target.style.backgroundColor = '#218838'}
              onMouseOut={(e) => e.target.style.backgroundColor = '#28a745'}
            >
